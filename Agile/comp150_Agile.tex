...
\abstract{Agile methods require constant effective communication of the development team in order to work effectively. This paper reviews communication issues that can occur with distributed development and the possible solutions to these problems. This paper recommends \textit{Agile Communication Model for Distributed Software Development} by S.Bhalerao for distributed game developers. }
